...
namespace Main023 {
    const char* BOX_VERTEX = "src02/shader/023.vert.glsl";
    const char* BOX_FRAGMENT = "src02/shader/023.frag.glsl";

    const char* LIGHT_VERTEX = "src02/shader/023_light.vert.glsl";
    const char* LIGHT_FRAGMENT = "src02/shader/023_light.frag.glsl";


    GLuint Main023::createBoxShaderProgram() {
    ...
    GLuint Main023::createLightShaderProgram() {
    ...
    int Main023::exec() {
        ...
        glUniform3f(glGetUniformLocation(boxProgram, "material.ambient"), 1.0f, 0.5f, 0.31f);
        glUniform3f(glGetUniformLocation(boxProgram, "material.diffuse"), 1.0f, 0.5f, 0.31f);
        glUniform3f(glGetUniformLocation(boxProgram, "material.specular"), 0.5f, 0.5f, 0.5f);
